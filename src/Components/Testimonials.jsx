...
const testimonials = [
  {
    ...
    name: "John Doe",
    image:
      "https://th.bing.com/th/id/OIP.Y8VsUuMz2o3UombnsvmrtgHaHa?o=7&cb=12rm=3&rs=1&pid=ImgDetMain&o=7&rm=3",
    review:
  ...
  },
  {
    ...
    name: "Sam Wilson",
    image:
      "https://media.istockphoto.com/id/1318928248/photo/portrait-of-a-young-man.jpg?s=612x612&w=0&k=20&c=ayy0fWfzLoC20BlYXDQmle1vz0a9Qrv8ssSwE3dLpzA=",
    review:
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center sm:gap-8">
        {testimonials.map((testimonial) => (
          <motion.div
            ...
            initial={{ opacity: 0, y: 20 }} // Start state (invisible, slightly below)
